...
import { faBoxOpen, faCalendarDays, faCalendarPlus, faCalendarXmark, faCircleXmark, faClock, faFolderOpen, faMicrophone, faPenToSquare, faPersonCirclePlus, faPlaneArrival, faPlaneCircleCheck, faPlaneCircleXmark, faPlaneDeparture, faPlus, faReply, faSquarePlus, faTrashCan, faUserXmark } from '@fortawesome/free-solid-svg-icons';
  ...
  return  <div className='relative flex flex-col justify-start items-start mt-[78px] lg:mt-[85px] h-auto w-full  lg:w-[calc(100%-296px)] ml-0 sm:ml-auto'>
        ...
        {/* schedule */}
         <LargeModal open={open3} setOpen={setOpen3}>
           ...
           {/* activate flight */}
           <Modal open={open10} setOpen={setOpen10}>
            <div className=" flex items-center justify-center py-[40px] px-4 sm:px-3 lg:px-2 bg-white_color bg-no-repeat bg-cover">
            <div className='flex flex-col justify-center items-center gap-6'>
            ...
            <Button onClick={()=>setOpen10(!open10)} color={"#777"} padding='5px'>Cancel</Button>
            </div>
    ...
    <div className="relative flex justify-center items-center">
        ...
        <input type="text" id="table-search-users" value={search} onChange={(e)=>setSearch(e.target.value)} className="block p-2 ps-10 text-lg shadow-xl border-r-0 shadow-black_color/40 text-white_color border border-gray-300 rounded-l-lg w-[180px] sm:w-[200px] lg:w-80 bg-black/5 focus:ring-blue-500 focus:border-blue-500   placeholder:text-secoundary_color dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for flight"/>
        ...
        <td className=" text-center  align-middle">
           {
            ...
            <button onClick={()=>{setOpen10(true);setData({id:flight?.flight_id,number:flight?.flight_number})}} className="font-bold text-[22px] text-green_color/80  m-2  hover:underline">
        ...
        <td className=" text-center  align-middle">
           {
            ...
            <button onClick={()=>{setOpen(true);setData({id:flight?.flight_id,number:flight?.flight_number})}} className="font-bold text-[22px] text-green_color/80  m-2  hover:underline">
            <FontAwesomeIcon icon={faReply} />
