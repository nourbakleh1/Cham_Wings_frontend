import { faBox, faChartPie, faChevronLeft, faCircleInfo, faFilePen, faInfo, faListCheck, faMessage, faNewspaper, faPlane } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
   ...
   <div className="h-full px-1 sm:px-3 py-4 w-[190px] sm:w-[256px]  overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul className="space-y-2 font-medium">
         <li>
            <NavLink end to="/employee" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <FontAwesomeIcon icon={faChartPie} />
               <span className="ms-3 text-[11px] md:text-[14px]">Dashboard</span>
            </NavLink>
         </li>
         <li>
            <NavLink to="/employee/manage-offers" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <FontAwesomeIcon icon={faListCheck} />
               <span className="flex-1 ms-3 whitespace-nowrap text-[11px] md:text-[14px]">manage offers</span>
            </NavLink>
         </li>
         <li>
            <NavLink to="/employee/reservation" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <FontAwesomeIcon icon={faBox} />
               <span className="flex-1 ms-3 whitespace-nowrap text-[11px] md:text-[14px]">view reservations</span>
            </NavLink>
         </li>
         <li>
            <NavLink to="/employee/manage-flights" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <NavLink to="/employee/answer-questions" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <FontAwesomeIcon icon={faMessage} />
               <span className="flex-1 ms-3 whitespace-nowrap text-[11px] md:text-[14px]">answer the questions</span>
            </NavLink>
         </li>
         <li>
            <NavLink to="/employee/view-history" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <FontAwesomeIcon icon={faNewspaper} />
               <span className="flex-1 ms-3 whitespace-nowrap text-[11px] md:text-[14px]">view modication history</span>
            </NavLink>
         </li>
         <li>
            <NavLink to="/employee/visa-information" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
