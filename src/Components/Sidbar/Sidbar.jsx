...
const Sidbar = (displaySidebar,setDisplaySidebar) => {
  ...
  return (
    ...
    <button id={"three"} onClick={handelSide} data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="fixed top-[10%] left-[0] p-2 mt-2 ms-3 text-sm  z-[500] text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
