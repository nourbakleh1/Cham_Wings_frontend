...
const Sidbar = (displaySidebar,setDisplaySidebar) => {
  ...
  return (
   ...
   <path clipRule="evenodd" fillRule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
        ...
        <aside id="default-sidebar" className="fixed top-[9%] sm:top-[10%] xl:top-[12%] left-0 transition-transform sm:translate-x-0 -translate-x-[110%] z-[40] w-44 sm:w-[256px] lg:w-[320px] h-screen " aria-label="Sidebar">
        <FontAwesomeIcon onClick={closeSide} icon={faChevronLeft} className='absolute top-[20%] left-[96%]  sm:hidden text-[30px] text-white_color bg-secoundary_color'/>
