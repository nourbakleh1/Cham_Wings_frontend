...
const DefaultModal = ({open,setOpen}) => {
  return (
    <>{
        open && 
 
 <div id="medium-modal" onClick={()=>setOpen(false)} tabIndex="-1" className="fixed top-0 bottom-0 bg-black_color/40 z-50  w-full p-4 overflow-x-hidden  flex justify-center max-h-full">
    <div className="relative w-full max-w-lg max-h-full">
        
        <div className="relative top-[30%] bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                ...
                <button onClick={()=>setOpen(false)} data-modal-hide="medium-modal" type="button" className="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Decline</button>
            </div>
        </div>
    </div>
</div>
