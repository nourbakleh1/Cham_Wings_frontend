...
const Modal = ({open,setOpen}) => {
  return (
    ...
    {
      open &&
      <div id="popup-modal" onClick={()=>setOpen(false)} tabIndex="-1" className="overflow-y-auto overflow-x-hidden fixed top-0 bottom-0 bg-black_color/40 flex justify-center  z-50  w-full  max-h-full">
    <div className="relative p-4 w-full max-w-md max-h-full">
        <div className=" relative top-[40%] bg-white rounded-lg shadow dark:bg-gray-700">
