...
const Modal = ({open,setOpen,children}) => {
  return (
    ...
    {
      open &&
      <div id="popup-modal"  tabIndex="-1" className="overflow-y-auto overflow-x-hidden fixed top-0 bottom-0 left-0 bg-black_color/40 flex justify-center items-center  z-50  w-full  max-h-full">
