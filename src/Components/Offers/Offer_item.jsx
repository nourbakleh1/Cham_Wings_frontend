...
const Offer_item = ({offer}) => {
  return (
    <>
        <section className='parent-offer p-5 basis-[500px] bg-white_color z-10 rounded-lg hover:shadow-2xl hover:shadow-[#00529B] transition-all delay-200 shadow-lg shadow-[#836E42]'>
