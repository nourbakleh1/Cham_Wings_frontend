...
const handelNav=()=>{
 ...
 const handelLogout=()=>{
  ...
  <Link to="login">
  <FontAwesomeIcon icon={faUser} className='text-[13px] cursor-pointer hidden lg:block lg:text-[20px] text-white_color  rounded-xl hover:text-primary_color'/>
  </Link>

  <div className='text-white text-[12px] lg:text-[18px] '>
    <Link to="login" className='p-2 hover:text-primary_color text-[16px] '>log in</Link>|
    <Link to={"register"} className='p-2 hover:text-primary_color text-[16px]'>register</Link>
  ...
  <button onClick={handelNav} data-collapse-toggle="navbar-user" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white_color rounded-lg md:hidden hover:bg-black_color focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-user" aria-expanded="false">
    ...
    {
      role == 4 || role == 5 || role == 6 || role == 7 || role == 8 ||role == 9 || role == 10 ||role == 11 || role == 12 ||role == 13 || role == 14 ?
       null
      ...
      <li>
        <NavLink onClick={handelNav} end to="our-services" className="block px-0 lg:px-3  md:text-white_color text-white_color  py-2   rounded md:bg-transparent md:dark:hover:text-blue-500  md:p-0  a" aria-current="page">OUR SERVICES</NavLink>
      </li>
      <li>
        <NavLink onClick={handelNav} to="offers" className="block px-0 lg:px-3 py-2  md:text-white_color  rounded hover:bg-gray-100   md:p-0 dark:text-white md:dark:hover:text-blue-500 a dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">OFFERS</NavLink>
      </li>
      <li>
        <NavLink onClick={handelNav} to="travel" className="block px-0 lg:px-3 py-2  md:text-white_color  rounded hover:bg-gray-100   md:p-0 dark:text-white md:dark:hover:text-blue-500 a dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">TRAVEL CONDITION</NavLink>
      </li>
      <li>
        <NavLink onClick={handelNav} to="about-us" className="block px-0 lg:px-3 py-2  md:text-white_color  rounded hover:bg-gray-100   md:p-0 dark:text-white md:dark:hover:text-blue-500 a dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">ABOUT</NavLink>
      </li>
      <li>
        <NavLink onClick={handelNav} to="contact-us" className="block px-0 lg:px-3 py-2  md:text-white_color  rounded hover:bg-gray-100   md:p-0 dark:text-white md:dark:hover:text-blue-500 a dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">CONTACT</NavLink>
      </li>
    ...
    {!user && <div className='text-white  p-3 flex flex-col md:hidden  dark:bg-gray-800 border-t-4 border-solid border-primary_color'>
